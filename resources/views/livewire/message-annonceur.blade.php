    ...
    <div class="row justify-content-center" style="padding: 2%; min-height: 600px;max-height: 600px">
         <div class="col-md-3">
             <div class="shadow" style="background-color: #00A1F1; padding :2%; border-radius: 20px; max-height: 10%">
                 <h2 class="text-center" style="color:white;">Liste des Acheteurs</h2>
             </div>
                 ...
                 <a class="shadow chat-client @if($conversation_activate == $conversation->id) active-chat @endif" wire:click="select_conversation({{ $conversation->id }})" >
                     <div class="row">
                         ...
                         <div class="col-md-8" style="padding-left: 0px !important">
                             ...
                             <span style="font-family: segouil;">Client : {{ strtoupper($conversation->user->name) }}</span>
                         </div>
                     </div>
                 </a>
                 @endforeach
                            ...
                            <div class="vertical-scrollable" wire:poll="mountData">
                                ...
                                @foreach ($messages as $message )
                                    ...
                                    @if(empty($message->annonceur_id))
                                        <div style="background-color: #00BB26; border:2px solide #000;color:white; width: max-content; padding: 1%; border-radius: 20px; margin-right: auto;margin-top: 2%">
                                            {{ $message->message }} <br>
